...
function Dashboard() {
	...
	return (
		<div className="dashboard pl-5 h-14">
			<h1 className="text-purple-600">Welcome to Your Dashboard</h1>
			<Row>
				<Col lg={3} sm={12}>
					<Form id={id}>
						<Form.Group>
							<Form.Label className="text-purple-600">Your Projects</Form.Label>
							<Form.Control
								size="md"
								as="select"
								multiple
									...
									<div >
										<Row >
											<Col size="2">
												<Card>
													<Card.Body>
														<Card.Title className="text-purple-600">
															Project: {data.title}
														</Card.Title>
											...
											<Col size="2">
												<Card>
													<Card.Body>
														...
														<Card.Text>{data.endDate}</Card.Text>
													</Card.Body>
												</Card>
											</Col>
										</Row>
