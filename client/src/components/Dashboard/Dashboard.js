                                ...
                                <div>
                                    <Row>
                                        <Col md={3} sm={12}>
                                            <Card className="dashboard-card">
                                                <Card.Body className="dashboard-card-info">
                                                    <Card.Title className="dashboard-card-title">Project: {data.title}</Card.Title>
                                                    <Card.Text>
                                                        {data.description}
                                                    </Card.Text>
                                                </Card.Body>
                                        ...
                                        <Col md={3} sm={12}>
                                            <Card className="dashboard-card">
                                                <Card.Body>
                                                    <Card.Title className="dashboard-card-title">Employees</Card.Title>
                                                    <Card.Text>
                                                        {data.employee}
                                                    </Card.Text>
                                                </Card.Body>
                                        ...
                                        <Col md={3} sm={12}>
                                            <Card className="dashboard-card">
                                                <Card.Body>
                                                    <Card.Title className="dashboard-card-title">Managers</Card.Title>
                                                    <Card.Text>
                                                        {data.manager}
                                                    </Card.Text>
                                                </Card.Body>
                                        ...
                                        <Col md={3} sm={12}>
                                            <Card className="dashboard-card">
                                                <Card.Body>
                                                    <Card.Title className="dashboard-card-title">Deadline / Days Remaining</Card.Title>
                                                    <Card.Text>
                                                        {data.endDate}
                                                        <br />
                                                        {deadline}
